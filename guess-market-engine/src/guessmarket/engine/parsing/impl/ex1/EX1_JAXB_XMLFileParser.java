...
import guessmarket.engine.parsing.jaxb.generated.ex1.Comision;
import guessmarket.engine.parsing.jaxb.generated.ex1.GMEvent;
import guessmarket.engine.parsing.jaxb.generated.ex1.GuessMarket;
...
public class EX1_JAXB_XMLFileParser implements FileParser {
    ...
    public EX1_JAXB_XMLFileParser() {
        try {
            this.jaxbContext = JAXBContext.newInstance("guessmarket.engine.parsing.jaxb.generated.ex1");
    ...
    public ParsedMarketData parse(String filePath) throws Exception {
        ...
        return new ParsedMarketData(getParsedEvents(guessMarket), Collections.emptyList());
    }
